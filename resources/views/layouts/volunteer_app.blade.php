        ...
        <div class="container">
            ...
            >
                ...
                <div class="offcanvas-header border-bottom">
                    <!-- Sidebar Logo -->
                    <a class="navbar-brand" href="{{ route('volunteer.Home') }}">
                    <img src="{{ asset('images/LOGO1.png') }}" class="logo" alt="Logo" width="55" height="55">
                    </a>
                    <button
                        type="button"
                ...
                <div class="offcanvas-body flex-column flex-lg-row p-lg-1">
                    ...
                    >
                        ...
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="{{ route('volunteer.calendar') }}">Calendar</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="{{ route('volunteer.messages') }}">Messages</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="{{ route('volunteer.gallery') }}">Gallery</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="{{ route('volunteer.notification') }}">Notification</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="{{ route('volunteer.about') }}">
